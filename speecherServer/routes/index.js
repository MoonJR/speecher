...
var scriptDetail = require('./scriptDetail');
/* GET home page. */
...
router.get('/scriptDetail/failList', scriptDetail.failList);
router.post('/test/getRecordPath', getRecord.getRecord);
router.get('/test/testList', tests.testList);
router.get('/main/totalFailList', main.totalFailList);
router.get('/main/wordDetail', main.wordDetail);
