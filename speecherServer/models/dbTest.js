...
exports.saveTest = function (userId, recordFilename, scriptId, testType, score, testDate, testScript, callback) {
  dbCollection.testCollection.insertOne({
      id: userId,
...
exports.saveWrongMorpheme = function (user_id, morpheme_array, paragraph_id, script_id, fallWords) {

  try {
    var wrongIdx = 0;
    db.open(function (err, db) {
      // var collection = db.collection('morpheme');
      var bulk = dbCollection.morphemeCollection;
